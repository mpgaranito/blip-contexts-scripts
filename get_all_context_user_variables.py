...
BOT_AUTHORIZATION = 'Key bot'
USER_IDENTITY = 'contato@wa.gw.msging.net'
...
if BOT_AUTHORIZATION == '' or USER_IDENTITY == '':
    print(
        f'[ERROR] Reason: : must have a valid bot_authorization key and USER_IDENTITY.'
    )
    exit(-1)
...
def get_all_context_request():
    return {
        ...
        'uri': f'/contexts/{USER_IDENTITY}?$take=1000'
    }
